            ...
            <SpinnerView isLoading={isLoading}>
                <div className="row">
                    ...
                    <Form onSubmit={(event)=>handleSubmit(event, data)} className="col">
                        <Input type="text" name="username" value={data.username} handleChange={handleChange} placeholder="Wpisz nazwę użytkownika (email)" required="required"/>
                        <Input type="password" name="password" value={data.password} handleChange={handleChange} placeholder="Wpisz hasło" required="required"/>
